...
export default class ToolbarAndroidComponent extends React.Component {
    constructor(){
        super();
        this.state={
...
const toolbarActions = [
    {title: 'Create', icon:require('./app_logo.png'),show: 'always'},
    {title: 'Action 1'},
    {title: 'Action 2'},
    {title: 'Action 3'},
    {title: 'Action 4'},
    {title: 'Add', icon:require('./add_icon.png'),show: 'always'},
]
